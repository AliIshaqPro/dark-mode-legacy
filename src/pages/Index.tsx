...
const Index = () => {
  ...
  return (
    <main className="pt-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <motion.div
                ...
                className="space-y-6"
              >
                <div className="inline-block px-4 py-2 rounded-full bg-neon-blue/10 text-neon-blue text-sm font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    to="/projects"
                    className="neo-button flex items-center justify-center"
                  >
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute -bottom-6 -right-6 p-4 glass-panel rounded-lg backdrop-blur-xl w-48">
              ...
              <div className="absolute -top-6 -left-6 p-4 glass-panel rounded-lg backdrop-blur-xl">
      ...
      {/* About Section */}
      <section ref={aboutRef} className="py-24 bg-dark-200/50 border-y border-white/5">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <AnimatedSection delay={0.1} direction="up" className="glass-panel p-8 rounded-xl">
              <div className="bg-neon-blue/20 w-12 h-12 rounded-full flex items-center justify-center text-neon-blue mb-6">
                <Code size={24} />
              </div>
              <h3 className="text-xl font-bold mb-4">WordPress Development</h3>
              ...
              <ul className="text-gray-400 space-y-3">
                <li className="flex items-center">
                  <span className="w-1.5 h-1.5 bg-neon-blue rounded-full mr-3"></span>
            ...
            <AnimatedSection delay={0.2} direction="up" className="glass-panel p-8 rounded-xl">
              <div className="bg-neon-purple/20 w-12 h-12 rounded-full flex items-center justify-center text-neon-purple mb-6">
                <Layers size={24} />
              </div>
            ...
            <AnimatedSection delay={0.3} direction="up" className="glass-panel p-8 rounded-xl">
              <div className="bg-neon-pink/20 w-12 h-12 rounded-full flex items-center justify-center text-neon-pink mb-6">
      ...
      <section className="py-24">
        <div className="container-custom">
          <AnimatedSection>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Work <span className="text-gradient">Experience</span></h2>
            ...
            {experienceData.map((item, index) => (
              <AnimatedSection 
                ...
                className={`relative mb-16 ${
                  index % 2 === 0 ? "text-right pr-8 md:pr-12 md:ml-auto md:mr-0" : "pl-8 md:pl-12"
                } md:w-1/2`}
              >
      ...
      <section className="py-24 bg-dark-200/50 border-y border-white/5">
        <div className="container-custom">
          <AnimatedSection>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-16">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">Featured <span className="text-gradient">Projects</span></h2>
                <p className="text-gray-400 max-w-2xl">A selection of my recent WordPress projects</p>
              </div>
              <Link
                to="/projects"
                className="mt-6 md:mt-0 neo-button flex items-center self-start"
              >
      ...
      <section className="py-24">
        <div className="container-custom">
          <AnimatedSection>
            <div className="glass-panel p-12 md:p-16 rounded-2xl relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <a 
                      ...
                      className="p-3 rounded-full bg-dark-400 border border-white/10 text-white hover:text-neon-blue transition-colors"
                    >
                      <Github size={20} />
                    </a>
                    <a 
